# US-Visa-Approval
#### MLOPs Production Ready ML Project- Classification Use Case
...
1. constants
2. entity (the path of constants, Both config and artifect entities)
3. components (stages)
4. pipeline  (connect the all stages)
5. Main file (main.py)
